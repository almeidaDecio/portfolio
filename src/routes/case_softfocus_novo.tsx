  ...
  head: () => ({
    meta: [
      { title: "Décio D'Almeida — Softfocus Zoom Rural" },
      {
        name: "description",
        content:
          "Case de produto: plataforma SaaS para monitoramento e fiscalização de operações de crédito rural para instituições financeiras.",
      },
    ],
  }),
  ...
  return (
    <PageContainer>
      ...
      <section className="-mt-6">
        <SectionHeader title="Plataforma SaaS para monitoramento de crédito rural" />
      </section>
      ...
      <section className="mt-14 mb-16">
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div className="flex items-center gap-4 rounded-2xl border border-border bg-card px-5 py-5 md:px-6">
            ...
            <div>
              <p className="text-lg font-medium text-muted-foreground">
                ampliação no uso da plataforma
              </p>
